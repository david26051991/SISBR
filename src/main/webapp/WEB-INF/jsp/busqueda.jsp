...
<script type="text/javascript">
	...
	function pintarListaDocumentos(lista){
		...
		if(lista != null && lista != ""){
			...
			strlHtml += '<div class="col-sm-3" align="right">';
			strlHtml += '	<button type="button" class="btn btn-default" id="btnExportar" onClick="javascript:exportar();"><span class="glyphicon glyphicon-export" aria-hidden="true"></span> Exportar</button>';
// 			strlHtml += '	<button type="button" class="btn btn-default" id="btnImprimir"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Imprimir</button>';
			strlHtml += '</div>';
			strlHtml += '</div>';
